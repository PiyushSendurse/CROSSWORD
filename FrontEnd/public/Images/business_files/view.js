...
if (typeof usi_js === 'undefined') {
	usi_js = {
		...
		display_vars: {
			...
			bottom: '',
			mobilefit: 0,
			background: "/chatskins/5698/Shutterstock-TT-2-2023-20off.jpg",
			p1: "",
			p2: "",
			intrinsic_size: {
				background: {
			...
			css: ".usi_display * {\tfont-size: 1em;\tline-height: 1.2;\tbox-sizing: border-box;\tcolor: inherit;\tfont-family: inherit;}.usi_display {\tcolor: #000;\tfont-family: inherit;}/* Submit Button */.usi_submitbutton:hover, .usi_submitbutton:active, .usi_submitbutton:focus {\tbackground: none;\tborder: none;\toutline: none;}.usi_submitbutton {\tposition: absolute;  top: 82.5%;  left: 13.5%;  width: 27.6%;  height: 9%;\tmargin: 0;\tpadding: 0;\tdisplay: inline-block;\toutline: none;\tbackground: none;\tborder: none;\tcursor: pointer;\ttext-align: center;}",
			focus_trap: 0
		},
		timers: {
			display_timer: -1,
  ...
  usi_cookies.set("usi_boostbar", "closed", usi_cookies.expire_time.week);
    ...
    usi_js.deep_link('https://www.shutterstock.com/explore/shutterstock-20th-anniversary');
  } else if (usi_app.is_image_in_cart) {
...
usi_js.display_vars.p1_html = [
  '<div class="usi_header1 usi_sr_only">',usi_app.messaging.header1,'</div>',
  '<div class="usi_header2 usi_sr_only">',usi_app.messaging.header2,'</div>',
  '<div class="usi_use_code usi_sr_only">',usi_app.messaging.use_code,'</div>',
  '<div class="usi_coupon_code usi_sr_only">HAPPY20TH</div>',
	'<button class="usi_submitbutton" onclick="usi_js.click_cta();" type="button" aria-label="',usi_app.messaging.cta,'"></button>',
].join('');
